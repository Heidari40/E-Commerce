    ...
    return (
        ...
        <section className=" bg-white py-2 sm:py-6">
            <div className="mx-auto  max-w-screen-xl px-2 sm:px-6 lg:px-8">
                <div className="flex flex-warp  grid grid-cols-4 items-center gap-4  ">
                    {data && data.length ?
                        data.map((item: any) => (
                            <article
                                className="relative flex flex-col justify-center items-center relative border border-gray-100  cursor-pointer"
                                key={item._id}
                            >
